...
function init_gear_sets()
	...
	HerculeanHelm = {}
	HerculeanHelm.WSD = { name="Herculean Helm", augments={'Accuracy+24','Weapon skill damage +5%','AGI+3',}}
	
	HerculeanLegs = {}
	HerculeanLegs.WSD = { name="Herculean Trousers", augments={'Accuracy+25 Attack+25','Weapon skill damage +4%','STR+2','Accuracy+12',}}
	
	HerculeanFeet = {}
	HerculeanFeet.TA = { name="Herculean Boots", augments={'Accuracy+16 Attack+16','"Triple Atk."+4',}}
	HerculeanFeet.WSD = { name="Herculean Boots", augments={'Attack+3','Weapon skill damage +8%','Accuracy+17 Attack+17','Mag. Acc.+20 "Mag.Atk.Bns."+20',}}
    
	Camulus = {}
	Camulus.LS = { name="Camulus's Mantle", augments={'AGI+20','Rng.Acc.+20 Rng.Atk.+20','AGI+10','Weapon skill damage +10%',}}
