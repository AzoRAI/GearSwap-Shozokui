...
function init_gear_sets()
  ...
  sets.idle = {
    ...
    head="Flam. Zucchetto +2", body={ name="Valorous Mail", augments={'Accuracy+27','"Dbl.Atk."+3','STR+10','Attack+11',}}, hands="Sulev. Gauntlets +2",
    legs="Pumm. Cuisses +2", feet="Pumm. Calligae +2",
    left_ring="Niqmaddu ring",right_ring="Flamma Ring",
    waist="Ioskeha Belt",back={ name="Cichol's Mantle", augments={'STR+20','Accuracy+20 Attack+20','STR+7','"Dbl.Atk."+10',}},
  }
  sets.idle.PDT = {
  ...
  sets.WS.Base = set_combine(sets.TP.Base, {
    ammo="Knobkierrie",
    neck=gear.ElementalGorget, waist=gear.ElementalBelt,
